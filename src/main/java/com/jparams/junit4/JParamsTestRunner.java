...
import com.jparams.junit4.description.DescriptionFactory;
import com.jparams.junit4.statement.ParameterizedTestStatement;
import com.jparams.junit4.util.Parameters;
...
public class JParamsTestRunner extends BlockJUnit4ClassRunner {
    ...
    public JParamsTestRunner(Class<?> testClass) throws InitializationError {
        super(testClass);
    ...
    private Description createDescription(FrameworkMethod method) {
        if (Parameters.isParameterized(method) && !isIgnored(method)) {
            Object[][] data = Parameters.getParameterizedData(method);
